...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2020 at 04:56 AM
...
--
CREATE DATABASE IF NOT EXISTS `big_brain_trivia` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `big_brain_trivia`;
...
('root', '[{\"db\":\"big_brain_trivia\",\"table\":\"users\"},{\"db\":\"big_brain_trivia\",\"table\":\"questions\"},{\"db\":\"big_brain_trivia\",\"table\":\"answers\"},{\"db\":\"big_brain_trivia\",\"table\":\"leaderboard\"},{\"db\":\"big_brain_trivia\",\"table\":\"USERS\"},{\"db\":\"big-brain-trivia\",\"table\":\"users\"}]');
...
('root', 'big_brain_trivia', 'answers', '{\"sorted_col\":\"`answers`.`question_id` ASC\"}', '2020-11-09 21:45:27'),
('root', 'big_brain_trivia', 'leaderboard', '{\"CREATE_TIME\":\"2020-11-09 23:05:52\",\"col_order\":[1,0],\"col_visib\":[1,1]}', '2020-11-10 02:15:26');
...
('root', '2020-11-10 03:56:16', '{\"Console\\/Mode\":\"show\",\"ThemeDefault\":\"original\",\"Console\\/Height\":266.97789}');
